...
<html lang="en">
  <head>
    ...
    <title>Mentor Connect|| Profile</title>
    <!-- plugins:css -->
          ...
          <div class="content-wrapper">
            ...
            <div class="row">
              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title" style="text-align: center;">Mentor Profile</h4>
...
{               ?>
                      <div class="form-group">
                        <label for="exampleInputName1">Mentor Name</label>
                      ...
                      <div class="form-group">
                        <label for="exampleInputCity1">Mentor Registration Date</label>
